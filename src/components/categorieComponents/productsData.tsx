            ...
            >
              ...
              <div className="relative h-64 flex items-center justify-center mb-4">
                ...
                <Heart 
                  ...
                  className={`absolute bottom-2 right-0 cursor-pointer transition-colors ${
                    favorites[product.id] ? "fill-[#C5B367] text-[#C5B367]" : "text-gray-300 hover:text-[#C5B367]"
                  }`} 
                />
              </div>
...
<div className="flex flex-col md:flex-row justify-between items-center mt-16 mb-8 gap-6">
  
  {/* Left/Center Side: Load More Button */}
  <div className="flex-1 flex justify-center lg:justify-end lg:pr-40">
  ...
  <div className="flex items-center gap-4 text-[13px] font-sans text-[#C5B367]">
    {/* Previous */}
