  ...
  return (
    <div className="max-w-[1350px] mx-auto p-4 font-sans bg-white">
      ...
      <div className="flex flex-col lg:flex-row gap-7 items-stretch">
        ...
        {/* 3. Main Content Area */}
        <div className="flex-1 flex flex-col order-3 lg:order-2">
          
          {/* Desktop Only Breadcrumb (Hidden on Mobile) */}
          <div className="hidden lg:flex items-center mb-8 overflow-x-auto no-scrollbar gap-0.5 pb-2">
            <Link
              href="/"
          ...
          {/* Banner Section */}
          <div className="relative bg-[#111111] h-[250px] md:h-[300px] flex items-center overflow-hidden"
            style={{
