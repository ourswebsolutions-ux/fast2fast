    ...
    <header className="w-full bg-black font-sans selection:bg-[rgb(199,177,93)] relative">
      ...
      >
        <div className="max-w-[1412px] border border-[rgb(199,177,93)]-6 mx-auto w-full flex items-center justify-between px- overflow-hidden">
          ...
          <div className="flex items-center gap-13 px-3 overflow-x-auto no-scrollbar py-2 w-full lg:w-auto">
            {/* Market Trigger */}
            <PriceItem
      ...
      <div className="h-[80px] lg:h-[100px] flex items-center px-4 max-w-[1412px] mx-auto justify-between relative z-50 bg-black">
        ...
        <div className="hidden lg:flex items-center gap-8 border flex-1 justify-cent px-15">
          ...
          <div className="flex flex-1 max-w-[644px] px-1 h-[45px]">
            ...
            <button className="w-[120px] bg-[rgb(199,177,93)] flex items-center justify-center hover:bg-[#b39e55]"><Search className="text-white" size={24} /></button>
          </div>
        </div>
