...
export default function Navbar() {
  ...
  return (
    <header className="w-full bg-black font-sans selection:bg-[rgb(199,177,93)] relative">
      ...
      >
        <div className="max-w-[1412px] border border-[rgb(199,177,93)]-6 mx-auto w-full flex items-center justify-between px-4 overflow-hidden">

          <div className="flex items-center gap-12 px- overflow-x-auto no-scrollbar py-2 w-full lg:w-auto">
            {/* Market Trigger */}
            <PriceItem
...
/>
          ...
          <div className="hidden lg:flex items-center px-2 border border-red-3 gap-6  shrink-0">
