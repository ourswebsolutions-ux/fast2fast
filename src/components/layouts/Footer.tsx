...
const Footer = () => {
    ...
    return (
        <footer className="w-full bg-black text-white  w-full h-full border-t-4 border-[rgb(199,177,93)] pt-16 pb-6 font-sans">
            <div className="mx-auto w-full max-w-[1412px]  px-2">

                {/* Newsletter Box - Fixed spacing & shape */}
                <div className="relative mb-16">
                    <div className="relative -mt-28 overflow-hidden bg-[rgb(168,155,101,255)] py-18 px-6 md:px-10 lg:px-12 shadow-2xl ">
                       ...
                       <div className="absolute left-0 top-0 h-full w-1/2 bg-gradient-to-r from-black/20 to-transparent">
                            ...
                            {/* LEFT */}
                            <div className="absolute md:left-100 hidden sm:block top-1/2 -translate-y-1/2 w-12 h-12  bg-black/10 rotate-45" />

                            {/* CENTER */}
                            <div className="absolute md:left-204 hidden sm:block top-1/2 -translate-x-2/2 -translate-y-1/2 w-65 h-65 bg-black/10 rotate-45" />

                            {/* RIGHT */}
                            <div className="absolute md:-right-66 hidden sm:block top-1/2 -translate-y-1/2 w-12 h-12  bg-black/10 rotate-45" />

                        </div>

                        {/* Content - Původní styl, fixnutý pro small screens */}
                        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between   text-center md:text-left md:gap-7">

                            {/* Text - Vráceno původní text-3xl a 4xl, fixnuto pro small screen přes md:w-auto */}
                            <div className="w-full md:w-auto flex-1 text-3xl ml-1 md:text-3xl -mr-1 lg:text-4xl font-serif text-white leading-tight md:pr-10">
                                Nezmeškejte žádné novinky či slevy!
                            </div>

                            {/* Input Box - Původní barvy a paddingy */}
                            <div className="w-full md:w-auto flex justify-end md:justify-end  md:mr-31">
                                <div className="flex flex-col sm:flex-row gap-4 items-center w-full max-w-md md:max-w-none">
                                    <input
                                        type="email"
                                        placeholder="Napište Váš e-mail"
                                        className="bg-black/20 border-none px-6 py-4.5 w-full sm:w-64 lg:w-83 text-white placeholder:text-white/80 outline-none focus:bg-black/30 transition-all text-sm "
                                    />
                                    <button className="bg-[rgb(199,177,93)] hover:bg-[rgb(167,145,75)] text-white px-6 py-4.5 md:py-5.5 font-bold text-[11px] tracking-[2px] transition-all whitespace-nowrap shadow-inner ">
                                        Přihlásit k odběru
                                    </button>
                                </div>
                            </div>
                ...
                {/* Rest unchanged */}
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 pt-7 md:mb-33">
                    {/* Column 1 */}
                    <div>
                        <h3 className="text-[rgb(199,177,93)]  font-serif text-xl mb-9">Hlavní kategorie</h3>
                        <ul className="flex flex-col gap-7 text-[13px] py- text-white">
                    ...
                    {/* Column 2 */}
                    <div>
                        <h3 className="text-[rgb(199,177,93)] font-serif text-xl mb-9">Důležité informace</h3>
                        <ul className="flex flex-col gap-7 text-[13px] text-white">
                    ...
                    {/* Column 3 */}
                    <div>
                        <h3 className="text-[rgb(199,177,93)] font-serif text-xl mb-9">Vše o nákupu</h3>
                        <ul className="flex flex-col gap-7 text-[13px] text-white">
                    ...
                    <div className="lg:pr-10">
                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            <div className="flex border-b border-zinc-800 pb-3 items-start gap-4 group cursor-pointer">
                                <div className="mt-1 transition-transform group-hover:scale-110">
                                ...
                                <div className=" pb-3 max-w-[150px] w-full transition-colors group-hover:border-[rgb(199,177,93)]">
                                    <p className="text-[20px] font- text-white mb-0.5 tracking-wider group-hover:text-[rgb(199,177,93)]">E-mail</p>
                                    <p className="text-[18px] text-white group-hover:text-[rgb(199,177,93)]">info@gulden.cz</p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-2.5 pt-3 ">
                                {icons.map((Item, idx) => {
                                    ...
                                    return (
                                        <div
                                            key={idx}
                                            className="w-10 h-10 flex items-center justify-center bg-[rgb(199,177,93)] hover:bg-white group transition-all cursor-pointer shadow-sm"
                                        >
                                            <Icon
                                                size={18}
               ...
               <div className="mt-1 pt-6 border-t border-zinc-900 flex flex-col md:flex-row justify-center items-center gap-8 text-[11px] text-black-500 tracking-[1px]">
                <div className="div  mx-auto w-full max-w-[1412px]  px-2 flex flex-col md:flex-row justify-between items-center gap-8 text-[11px] text-black-500 tracking-[1px]">
