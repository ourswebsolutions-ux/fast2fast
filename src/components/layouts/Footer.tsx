...
const Footer = () => {
    ...
    return (
        <>
        <footer className=" hidden md:block w-full bg-black text-white  w-full h-full border-t-4 border-[rgb(199,177,93)] pt-16 pb-6 font-sans">
            <div className="mx-auto w-full md:max-w-[1412px]  px-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 pt-7 md:mb-33">
                    ...
                    {/* Column 2 */}
                    <div>
                        <h3 className="text-[rgb(199,177,93)] font-serif text-xl mb-3 md:mb-9">Důležité informace</h3>
                    ...
                    {/* Column 3 */}
                    <div>
                        <h3 className="text-[rgb(199,177,93)] font-serif text-xl  md:mb-9">Vše o nákupu</h3>
                        <ul className="flex flex-col gap-7 text-[13px] text-white">
