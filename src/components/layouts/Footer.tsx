...
const Footer = () => {
    return (
        <footer className="w-full bg-black text-white pt-20 pb-6 font-sans mt-28">
            <div className="w-full max-w-[1350px] mx-auto px-4 md:px-10 lg:px-16 mb-16 relative">
                <div className="relative -mt-32 overflow-hidden bg-[#C9B067] p-6 md:p-8 lg:py-8 lg:px-12 shadow-2xl rounded">
                    ...
                    <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-6">
                        ...
                        {/* Input aur Button ke corners ko bhi rounded kiya hai */}
                        <div className="flex flex-col sm:flex-row w-full lg:w-auto gap-3 sm:gap-0 shadow-xl group overflow-hidden rounded-lg">
                            <input
                                type="email"
                                placeholder="Napište Váš e-mail"
                                className="bg-black/20 border-none px-6 py-3.5 w-full sm:w-64 lg:w-80 text-white placeholder:text-white/80 outline-none focus:bg-black/30 transition-all text-sm sm:rounded-l-lg sm:rounded-r-none rounded-lg"
                            />
                            <button className="bg-[#e0c885] hover:bg-white hover:text-[#C9B067] text-white px-8 py-3.5 font-bold uppercase text-[10px] md:text-[11px] tracking-[2px] transition-all whitespace-nowrap shadow-inner sm:rounded-r-lg sm:rounded-l-none rounded-lg">
                                Přihlásit k odběru
                            </button>
                        </div>
                    </div>
            ...
            {/* Baqi content GridLayout mein taake columns barabar rahein */}
            <GridLayout>
                {/* Column 1: Hlavní kategorie */}
                <div className="col-span-12 sm:col-span-6 lg:col-span-3 mb-10 lg:mb-0">
                ...
                <div className="col-span-12 sm:col-span-6 lg:col-span-3">
                    ...
                    <div className="flex flex-col gap-6">
                        <div className="flex items-start gap-4 group cursor-pointer">
                            ...
                            <div className="border-b border-zinc-800 pb-3 max-w-[200px] w-full transition-colors group-hover:border-[#C9B067]">
                                <p className="text-[12px] font-bold text-zinc-400 mb-0.5 uppercase tracking-wider group-hover:text-[#C9B067] transition-colors">Infolinka</p>
                                <p className="text-[14px] text-zinc-400 transition-colors group-hover:text-[#C9B067]">+420 800 01 02 03</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-4 group cursor-pointer">
                            ...
                            <div className="border-b border-zinc-800 pb-3 max-w-[200px] w-full transition-colors group-hover:border-[#C9B067]">
                                <p className="text-[12px] font-bold text-zinc-400 mb-0.5 uppercase tracking-wider group-hover:text-[#C9B067] transition-colors">E-mail</p>
                                <p className="text-[14px] text-zinc-400 transition-colors group-hover:text-[#C9B067]">info@gulden.cz</p>
                            </div>
                        </div>
                ...
                {/* Bottom Bar */}
                <div className="col-span-12 mt-16 pt-8 border-t border-zinc-900 flex flex-col md:flex-row justify-between items-center gap-8 text-[11px] text-zinc-500 uppercase tracking-[1px]">
                    ...
                    <p className="font-medium text-center md:text-left">Copyright 2023 GULDEN. Všechna práva vyhrazena.</p>
                    <div className="flex items-center gap-2 group cursor-pointer">
                        <div className="flex gap-[1px]">
                            <span className="w-1.5 h-1.5 bg-[#FFD700]" />
                            <span className="w-1.5 h-1.5 bg-[#00AEEF]" />
                        </div>
