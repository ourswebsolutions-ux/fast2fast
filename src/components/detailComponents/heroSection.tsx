...
const HeroSection: React.FC = () => {
    ...
    return (
        <section className="py-6 md:py-10 px-3 md:px-4 bg-gray-100 font-sans">
            <div className="max-w-[1350px] mx-auto grid grid-cols-12 gap-8 lg:gap-12">
                ...
                <div className="col-span-12 md:col-span-6 lg:col-span-7 rounded">
                    <div className="relative bg-white border border-gray-100 p-4 pt-24 md:pt-10 md:p-8 flex flex-col md:flex-row justify-center items-center min-h-[350px] md:min-h-[550px]">
                        ...
                        <div className="flex md:absolute flex-col gap-1.5 z-10 w-full md:w-auto md:top-6 md:left-6 mb-4 md:mb-0">
                            <span className="w-fit bg-white border border-gray-200 text-[11px] px-3 py-1 text-gray-400">Novinka</span>
                            <span className="w-fit bg-black text-white text-[11px] px-3 py-1 font-bold ">Množstevní slevy %</span>
                            <span className="w-fit bg-white border border-gray-200 text-[11px] px-3 py-1 text-gray-400">Online výkupní cena</span>
                        </div>
                        ...
                        <img
                            src="/imgcoin.svg"
                            alt="Coin"
                            className="w-[60%] md:max-w-[320px] lg:max-w-[400px] h-auto object-contain drop-shadow-2xl mt-4 md:mt-0"
                        />
                    </div>
                    ...
                    <div className="flex gap-2 mt-4 overflow-x-auto">
                        {[0, 1, 2].map((i) => (
                            <div key={i} className={`min-w-[64px] w-16 h-16 md:w-20 md:h-20 border p-1 cursor-pointer transition-all hover:border-[#C5A059] ${i === 0 ? 'border-[#C5A059]' : 'border-gray-200'}`}>
                ...
                <div className="col-span-12 md:col-span-6 lg:col-span-5">
                    <h1 className="text-2xl md:text-3xl font-sans text-[#333333] leading-tight ">
                        Kanada 50$ 2018 Maple Leaf 1 oz 999,9/1000 Au
                    </h1>

                    <p className="text-[#666666] text-[13px] mt-4 leading-relaxed">
                    ...
                    {/* Price Section */}
                    <div className="mt-8">
                        <div className="text-[#E54B4B] text-xs line-through font-medium">46 003 Kč</div>
                        <div className="flex items-baseline gap-4 mt-1">
                            <span className="text-4xl md:text-5xl font-bold text-[#00A651]">45 703 Kč</span>
                    ...
                    <div className="flex gap-2 mt-8 h-12">
                        ...
                        <button
                            ...
                            className="bg-[#00A651] hover:bg-[#008d44] text-white text-[11px] font-bold tracking-wider transition-colors px-10 py-3.5 min-w-[160px]"
                        >
                            Přidat do košíku
                        </button>
                    ...
                    {/* Pricing Table - Updated to White BG and clean lines */}
                    <div className="mt-10 border border-gray-200 bg-white">
                        <table className="w-full text-left text-[11px] md:text-xs border-collapse">
                            <thead className="bg-[#f9f9f9] text-[#333333] border-b border-gray-200 font-bold">
                                <tr>
                                    <th className="px-4 py-3 border-r border-gray-200 last:border-r-0">Množství</th>
                                    <th className="px-4 py-3 border-r border-gray-200 last:border-r-0">Cena</th>
                                    <th className="px-4 py-3 border-r border-gray-200 last:border-r-0">Fixace ceny</th>
                                    <th className="px-4 py-3">Platba kartou</th>
                                </tr>
                            </thead>
                            <tbody className="text-[#333333]">
                                {[{ q: '1–19', p: '45 703 Kč', f: 'Ihned', c: 'Ano' }, { q: '20–99', p: '44 703 Kč', f: 'Ihned', c: 'Ano' }, { q: '100–499', p: '43 703 Kč', f: 'Ihned', c: 'Ano' }, { q: '500+', p: '42 703 Kč', f: 'Po zaplacení', c: 'Ne' }].map((row, i) => (
                                    <tr key={i} className="border-b border-gray-200 last:border-b-0 hover:bg-gray-50 transition-colors">
                                        <td className="px-4 py-3.5 border-r border-gray-200 last:border-r-0">{row.q}</td>
                                        <td className="px-4 py-3.5 border-r border-gray-200 last:border-r-0 font-bold">{row.p}</td>
                                        <td className="px-4 py-3.5 border-r border-gray-200 last:border-r-0">{row.f}</td>
                            ...
                            {[0, 1].map((idx) => (
                                <div key={idx} className="flex items-center justify-between gap-4 p-4 hover:bg-gray-50 transition-colors">
                                    ...
                                    <div className="flex items-center gap-6">
                                        ...
                                        {/* Price */}
                                        <span className="font-bold text-[13px] text-[#333333] min-w-[40px] text-right">10 Kč</span>
                                    </div>
                                </div>
                            ))}
                        </div>
